...
// Effects (byte 6). Kept synchronized across every controller so firmware can share the same
// show-control API, even though the HV controller does not itself render decorative lighting.
